...
/**
 * Main class of the sample. Launch the PrimeGenerator, waits five seconds and interrupts the Thread
 */
public class Main {

	/**
	 * Main method of the sample. Launch the PrimeGenerator, waits five seconds and interrupts the Thread
	 * @param args
	 */
