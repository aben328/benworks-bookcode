...
/**
 * Main class of the example. Creates and execute ten FactorialCalculator tasks in an executor controlling when they
 * finish to write the results calculated
 */
public class Main {
