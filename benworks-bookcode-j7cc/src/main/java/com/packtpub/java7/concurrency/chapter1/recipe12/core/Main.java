...
/**
 * Main class of the example. Creates a Thread factory and creates ten Thread objects using that Factory
 */
public class Main {

	/**
	 * Main method of the example. Creates a Thread factory and creates ten Thread objects using that Factory
	 * @param args
	 */
