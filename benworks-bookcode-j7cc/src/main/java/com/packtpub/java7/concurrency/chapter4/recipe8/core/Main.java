...
/**
 * Main class of the example. Send a task to the executor that will execute every two seconds. Then, control the
 * remaining time for the next execution of the task
 */
public class Main {
