...
/**
 * This class implements the task of this example. It waits during a random <br>
...
public class Task implements Callable<Result> {
	...
	/**
	 * Main method of the task. Waits during a random period of time and then calculates <br>
