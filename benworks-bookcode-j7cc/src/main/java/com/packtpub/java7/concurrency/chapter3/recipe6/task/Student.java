...
public class Student implements Runnable {
	...
	/**
	 * Main method of the student. It arrives to the exam and does three exercises. After each exercise, it calls the
	 * phaser to wait that all the students finishes the same exercise
	 */
	public void run() {
