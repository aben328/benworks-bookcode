...
/**
 * This class calculates the factorial of a number. It can be executed in an executor because it implements de Callable
 * interface. The call method() will return an Interger
 */
