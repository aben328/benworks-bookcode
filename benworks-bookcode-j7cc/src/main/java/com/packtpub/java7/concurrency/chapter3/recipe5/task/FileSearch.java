...
public class FileSearch implements Runnable {
	...
	/**
	 * Phaser to control the execution of the FileSearch objects. Their execution will be divided in three phases 1st:
	 * Look in the folder and its subfolders for the files with the extension 2nd: Filter the results. We only want the
	 * files modified today 3rd: Print the results
	 */
	...
	/**
	 * This method checks if there are results after the execution of a phase. If there aren't results, deregister the
	 * thread of the phaser.
